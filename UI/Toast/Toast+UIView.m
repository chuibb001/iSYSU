...
static const CGFloat CSToastHorizontalPadding   = 110.0;
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.backgroundColor = [[UIColor colorWithRed:26.0/255.0 green:100.0/255.0 blue:180.0/255.0 alpha:1.0] colorWithAlphaComponent:CSToastOpacity];
